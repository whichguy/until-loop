...
This is the 0.3.0-rc.4 guide, retained for durable-run compatibility and historical
experiment provenance. Its new-task defaults and source-candidate version are
historical. Current new runs follow the [callback guide](../README.md).
